 ...
 */
package org.opendaylight.service.cli.commands;
...
public class ServiceCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ServiceCliTestCommand.class);
    protected final ServiceCliCommands service;

    public ServiceCliTestCommand(final ServiceCliCommands service) {
