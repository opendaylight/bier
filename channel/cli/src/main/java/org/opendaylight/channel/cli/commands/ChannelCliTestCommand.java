 ...
 */
package org.opendaylight.channel.cli.commands;
...
public class ChannelCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ChannelCliTestCommand.class);
    protected final ChannelCliCommands service;

    public ChannelCliTestCommand(final ChannelCliCommands service) {
