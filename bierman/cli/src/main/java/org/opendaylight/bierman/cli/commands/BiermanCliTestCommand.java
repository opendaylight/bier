 ...
 */
package org.opendaylight.bierman.cli.commands;
...
public class BiermanCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(BiermanCliTestCommand.class);
    protected final BiermanCliCommands service;

    public BiermanCliTestCommand(final BiermanCliCommands service) {
