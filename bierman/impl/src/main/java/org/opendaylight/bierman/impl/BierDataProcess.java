...
public class BierDataProcess<T> implements Callable<ListenableFuture<T>>,  TransactionChainListener {
    private static final Logger LOG =  LoggerFactory.getLogger(BierDataProcess.class);
    ...
    protected final BlockingQueue<BierDataOperation> mqueTopoOperation =
    ...
    public BierDataProcess(final DataBroker dataBroker, final int processFlag, final T tt) {
    ...
    public ListenableFuture<T> call() throws Exception {
        ...
        //try
        {
            BierDataOperation op = mqueTopoOperation.take();
    ...
    public void enqueueOperation(final BierDataOperation task) {
        try {
