 ...
 */
package org.opendaylight.topomanager.cli.commands;
...
public class TopomanagerCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(TopomanagerCliTestCommand.class);
    protected final TopomanagerCliCommands service;

    public TopomanagerCliTestCommand(final TopomanagerCliCommands service) {
